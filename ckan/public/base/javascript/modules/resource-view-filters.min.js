...
return{initialize:initialize,options:{dropdownTemplate:['<div class="resource-view-filter">','  {filter}:','  <div class="resource-view-filter-values"></div>','</div>',].join('\n'),addFilterTemplate:['<a href="#" class="btn btn-default background-search"><span class="glyphicon glyphicon-plus" style="margin-right:10px"></span>Agregar Filtro</a>',].join('\n')}};});
